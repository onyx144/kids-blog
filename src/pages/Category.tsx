        ...
        <div className="container mx-auto px-4">
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.map(post => (
                <Link key={post.slug} to={`/posts/${post.slug}`} className=" w-full">
                  <Card className="w-full hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden border-2 hover:border-kidsPrimary">
